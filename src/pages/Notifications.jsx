          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                {Object.entries(groupedNotifications).filter(([key]) => key !== 'emergency').map(([category, categoryNotifications]) => (
                            ...
                            <ListItemText
                              primary={
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                  ...
                                  {!notification.isRead && (
                                    <Chip label="New" color={getNotificationColor(notification.type)} size="small" />
                                  )}
                                </Box>
                              }
                              secondary={
